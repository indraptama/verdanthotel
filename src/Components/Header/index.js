	...
	render() {
		return (
          ...
          <Link href="/" className="dib link white mh3 f5">Home</Link>
					<Link href="/" className="dib link white mh3 f5">Room & Suite</Link>
					<Link href="/explore" className="dib link white mh3 f5">Explore</Link>
          <Link href="/explore" className="dib link white mh3 f5">Facilities</Link>
          <Link href="/explore" className="dib link white mh3 f5">Contact</Link>
				</nav>
        <button>login</button>
			</header>
		);
